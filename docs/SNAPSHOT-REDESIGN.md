...
- [x] Export the selected phase, route, stable playthrough identity version, persistence result and player-selection provenance.
...
- [x] Define focused summaries for production, logistics, power, Dyson construction, SPHERE and PHOTON receiver continuity.
