...
This directory contains completed planning, migration, implementation, and
validation records. These files preserve why the maintained product took its
current shape, but they are not active work and do not override
...
- Feature-specific guide 2.0 and production-risk runtime gates.
