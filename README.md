...
- Compact snapshot schema 2.18 exports conclusions, production-risk terms,
...
authorized [the Guide 3.0 roadmap](docs/ROADMAP.md); GC3-01/02 are technically
complete and GC3-03 is next. [Execution records](docs/management/GUIDE3-EXECUTION.md)
