...
- Compact snapshot schema 2.21 exports conclusions, production-risk terms,
...
authorized [the Guide 3.0 roadmap](docs/ROADMAP.md); GC3-01 through GC3-05 are technically
complete; G1 passed and GC3-06 is next. [Execution records](docs/management/GUIDE3-EXECUTION.md)
